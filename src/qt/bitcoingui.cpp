    ...
    rpcConsole(0)
{
    ...
    QString windowTitle = tr("xDeus") + " - " + tr("Wallet");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a xDeus address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About xDeus"), this);
    aboutAction->setToolTip(tr("Show information about xDeus"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for xDeus"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("xDeus client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to xDeus network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid xDeus address or malformed URI parameters."));
    }
